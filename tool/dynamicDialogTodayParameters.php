...
$today=new Today();
  ...
  echo '<tr><td></td><td>&nbsp;</td></tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" width="10px;"><label>'.i18n('todayRefreshParametersRefresh').'&nbsp;:&nbsp;</label></td>';
  echo '  <td>';
  ...
  echo '</tr>';
  echo '<tr style="height:10px;">';
  echo '  <td class="dialogLabel" width="10px;"><label>'.i18n('todayRefreshParametersScroll').'&nbsp;:&nbsp;</label></td>';
  echo '  <td>';
